...
icons:
  ...
  - name: promonium
    icon: /src/icons/promonium-logistics.mp4
  - name: git
  ...
  - name: pro-box
    icon: /src/icons/pro-box.svg
  - name: pro-consult
    icon: /src/icons/pro-consult.svg
  - name: pro-fulfilment
    icon: /src/icons/pro-fulfilment.svg
  - name: pro-security
  ...
  - name: pro--distribution
    icon: /src/icons/pro--distribution.svg
  - name: proi--storage
